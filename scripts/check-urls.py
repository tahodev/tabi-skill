...
WARN_HOSTS={'emb-japan.go.jp', 'www.koreaexim.go.kr', 'odp.airport.kr', 'ecos.bok.or.kr', 'koreaexim.go.kr', 'www.arex.or.kr', 'swopenapi.seoul.go.kr', 'apis.data.go.kr', 'openapi.tago.go.kr', 'arex.or.kr', 'openapi.seoul.go.kr', 'data.go.kr'}
OPENAPI_HOSTS={'odp.airport.kr', 'ecos.bok.or.kr', 'koreaexim.go.kr', 'swopenapi.seoul.go.kr', 'apis.data.go.kr', 'openapi.tago.go.kr', 'openapi.seoul.go.kr', 'data.go.kr'}
...
def api_error(body):
    pats=[r'ERROR-[0-9]+',r'"(?:resultCode|returnCode|code)"\s*:\s*"?(?!00\b|INFO-000\b|0\b)([A-Z0-9_-]+)',r'<resultCode>\s*(?!00<)([^<]+)']
    for p in pats:
